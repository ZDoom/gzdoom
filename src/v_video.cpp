...
IMPLEMENT_CLASS(DCanvas, true, false, false)
IMPLEMENT_CLASS(DFrameBuffer, true, false, false)
...
IMPLEMENT_CLASS(DDummyFrameBuffer, true, false, false)

// SimpleCanvas is not really abstract, but this macro does not
// try to generate a CreateNew() function.
IMPLEMENT_CLASS(DSimpleCanvas, true, false, false)
