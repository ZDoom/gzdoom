...
public:
	...
	static bool SetupModelMatrix(VSMatrix &objectToWorldMatrix, float x, float y, float z, FSpriteModelFrame *smf, AActor *actor, double ticFrac);
	static bool SetupHUDModelMatrix(VSMatrix &objectToWorldMatrix, FSpriteModelFrame *smf, float ofsX, float ofsY);
	...
	void RenderModel(FSpriteModelFrame *smf, AActor *actor, bool mirrored);
	void RenderHUDModel(FSpriteModelFrame *smf, DPSprite *psp, bool mirrored);
