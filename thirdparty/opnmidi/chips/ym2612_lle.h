...
#ifndef YM2612LLE_OPN2_H
#define YM2612LLE_OPN2_H

#include "opn_chip_base.h"

class Ym2612LLEOPN2 final : public OPNChipBaseT<Ym2612LLEOPN2>
{
    void *m_chip;
public:
    Ym2612LLEOPN2(OPNFamily f);
    ~Ym2612LLEOPN2() override;
