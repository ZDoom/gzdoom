...
private:
	...
	void SplitLeftEdge(texcoord * tcs, FBufferVertex *&ptr);
	void SplitRightEdge(texcoord * tcs, FBufferVertex *&ptr);
	void SplitUpperEdge(texcoord * tcs, FBufferVertex *&ptr);
	void SplitLowerEdge(texcoord * tcs, FBufferVertex *&ptr);
