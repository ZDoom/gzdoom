...
void SetupMaterial(inout Material material)
{
	...
	// Ideally fuzzpos would be an uniform and differ for each sprite so that overlapping demons won't get the same shade for the same pixel
	...
	material.Base = vec4(0.0, 0.0, 0.0, basicColor.a * alpha);
}
