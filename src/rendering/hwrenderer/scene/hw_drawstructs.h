...
public:
	...
	bool CalculateVerticesSimple(HWDrawInfo *di, FVector3 *v, DVector3 *vp);
...
public:
	...
	void ProcessSimple(HWDrawInfo *di, AActor* thing, sector_t * sector, area_t in_area, int thruportal = false);
