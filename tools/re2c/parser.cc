...
static const yytype_int8 yyrhs[] =
{
      20,     0,    -1,    -1,    20,    22,    -1,    20,    21,    -1,
       5,    12,    24,    13,    -1,     5,    12,    24,    14,    -1,
       9,    12,    10,    13,    -1,     9,    12,    11,    13,    -1,
...
{
       0,    84,    84,    86,    88,    91,    95,    97,    99,   103,
     108,   109,   113,   115,   119,   121,   128,   130,   134,   136,
     150,   156,   158,   162,   166,   168,   170
};
#endif
...
#line 84 "./parser.y"
  ...
  case 3:
#line 87 "./parser.y"
    { spec = spec? mkAlt(spec, (yyvsp[(2) - (2)].regexp)) : (yyvsp[(2) - (2)].regexp); ;}
    break;
...
#line 96 "./parser.y"
  ...
  case 7:
#line 98 "./parser.y"
    { in->config(*(yyvsp[(1) - (4)].str), *(yyvsp[(3) - (4)].str)); delete (yyvsp[(1) - (4)].str); delete (yyvsp[(3) - (4)].str); ;}
    break;

  case 8:
#line 100 "./parser.y"
    { in->config(*(yyvsp[(1) - (4)].str), (yyvsp[(3) - (4)].number)); delete (yyvsp[(1) - (4)].str); ;}
    break;

  case 9:
#line 104 "./parser.y"
    { (yyval.regexp) = new RuleOp((yyvsp[(1) - (3)].regexp), (yyvsp[(2) - (3)].regexp), (yyvsp[(3) - (3)].token), accept++); ;}
    break;
