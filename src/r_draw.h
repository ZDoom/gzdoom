...
void R_DrawMaskedColumnHoriz (const BYTE *column, const FTexture::Span *spans, WORD depth=0);
...
void wallscan (int x1, int x2, short *uwal, short *dwal, fixed_t *swal, fixed_t *lwal, fixed_t yrepeat, WORD idepth=0, float idepthStep=0, const BYTE *(*getcol)(FTexture *tex, int col)=R_GetColumn);

// maskwallscan is exactly like wallscan but does not draw anything where the texture is color 0.
void maskwallscan (int x1, int x2, short *uwal, short *dwal, fixed_t *swal, fixed_t *lwal, fixed_t yrepeat, WORD idepth=0, float idepthStep=0, const BYTE *(*getcol)(FTexture *tex, int col)=R_GetColumn);

// transmaskwallscan is like maskwallscan, but it can also blend to the background
void transmaskwallscan (int x1, int x2, short *uwal, short *dwal, fixed_t *swal, fixed_t *lwal, fixed_t yrepeat, WORD idepth=0, float idepthStep=0, const BYTE *(*getcol)(FTexture *tex, int col)=R_GetColumn);
